...
public class Gui {
    protected static JFrame frame = new JFrame("GSA Document Signing Tool 2.0");
    ...
    public Component createComponents(JFrame frame) {
        ...
        fileDestination.setToolTipText("This is the file destination of the file you would like signed or unpacked.");
        ...
        signButton.addActionListener(new ActionListener() {
           ...
           public void actionPerformed(ActionEvent e) {
               progress.setValue(0);
               status.setText(dateFormat.format(new Date()) + " - Applying Signature\n");
               progress.setValue(8);
        ...
        verifyButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                progress.setValue(0);
                status.setText(dateFormat.format(new Date()) + " - Unpacking File\n");
                progress.setValue(8);
        ...
        openFile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/gsa/signingtool/app/images/open.png"))); // NOI18N
        ...
        closeApp.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.CTRL_MASK));
        closeApp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/gsa/signingtool/app/images/close.png")));
        ...
        aboutMenu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/gsa/signingtool/app/images/info.png"))); // NOI18N
...
// add menuBar items and menuBar to the frame
        ...
        browseButton.getAccessibleContext().setAccessibleDescription("Click button to open a file to sign");
        ...
        fileInput.getAccessibleContext().setAccessibleDescription("Please select a file to sign");
        fileInput.getAccessibleContext().setAccessibleParent(frame);
        fileDestLabel.getAccessibleContext().setAccessibleParent(frame);
        fileDestination.getAccessibleContext().setAccessibleName("File Destination");
        signButton.getAccessibleContext().setAccessibleName("Sign Button");
        signButton.getAccessibleContext().setAccessibleDescription("Click button to sign a file");
        signButton.getAccessibleContext().setAccessibleParent(frame);
        verifyButton.getAccessibleContext().setAccessibleDescription("Click button to unpack a file");
        verifyButton.getAccessibleContext().setAccessibleName("Unpack Button");
        verifyButton.getAccessibleContext().setAccessibleParent(frame);
        pin.getAccessibleContext().setAccessibleName("PIN Number");
        pin.getAccessibleContext().setAccessibleDescription("Text field for entering your PIN Number");
        ...
        frame.getAccessibleContext().setAccessibleDescription("GSA PKCS#7 Signing Tool");
        frame.setIconImage(new ImageIcon(getClass().getResource("/com/gsa/signingtool/app/images/icon.png")).getImage());
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(fileDestLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addComponent(browseButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(progress, javax.swing.GroupLayout.PREFERRED_SIZE, 450, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(pin, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(fileInput)
                        .addComponent(fileDestination, javax.swing.GroupLayout.PREFERRED_SIZE, 450, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(statusScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 450, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(statusScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 174, Short.MAX_VALUE))
                 .addContainerGap()
            ));
    ...
    private void browseButtonActionPerformed(java.awt.event.ActionEvent evt) {                                             
        int returnVal = fileChooser.showOpenDialog(frame);
                if(returnVal == JFileChooser.APPROVE_OPTION) {
                    ...
                    fileDestination.setText(file.getAbsolutePath().substring(0,file.getAbsolutePath().lastIndexOf(File.separator)));
    ...
    private void aboutMenuActionPerformed(java.awt.event.ActionEvent evt) {                                           
        JOptionPane.showMessageDialog(frame, "The PKCS#7 Signing Tool is a free tool provided\n"
                + " by the General Services Agency (GSA). The primary\n"
    ...
    public SwingWorker<Boolean, String> createVerifyWorker(final javax.swing.JTextArea status, final JProgressBar progress) {
            ...
            protected void done() {
                try {
                    ...
                    if (Boolean.TRUE.equals(ack)) {
                        if (errors == false) {
                            logger.info("File was verified/unpacked successfully with no errors.");
                            status.append(dateFormat.format(new Date()) 
                                    + " - File has been successfully unpacked.");
                        } else {
                            logger.severe("Errors were found while unpacking action was running");
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public SwingWorker<Boolean, String> createWorker(final javax.swing.JTextArea status, final JProgressBar progress) {
        return new SwingWorker<Boolean, String>() {
            @Override
            protected Boolean doInBackground() throws Exception {
                ...
                try {
                    ...
                    if (Boolean.TRUE.equals(ack)) {
                        if (errors == false) {
                            ...
                            logger.severe("Errors were found when signing action was completed");
                        }
                    }
                } catch (Exception e) {
                    e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        logger.info("Launching the PKCS#7 Signing Tool Application...");
